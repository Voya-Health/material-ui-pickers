...
exports.Day = function (_a) {
    var _b;
    var children = _a.children, disabled = _a.disabled, hidden = _a.hidden, current = _a.current, selected = _a.selected, ariaLabel = _a.ariaLabel, other = __rest(_a, ["children", "disabled", "hidden", "current", "selected", "ariaLabel"]);
    ...
    var className = clsx_1.default(classes.day, (_b = {},
        ...
        _b));
    return (React.createElement(IconButton_1.default, __assign({ className: className, tabIndex: hidden || disabled ? -1 : 0, "aria-label": ariaLabel }, other),
